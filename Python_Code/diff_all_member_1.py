...
movie_path = "/fujita/左.mp4"

output_csv_path = "/fujita/output/"
#output_image_path = "/fujita/1min_output/"

threshold = 5
csv_file = pd.read_csv("/fujita/ROI_left.csv", index_col=None).values.tolist()
# print(csv_file)
# print(csv_file[0])
    ...
    while True:
        ...
        if ret:
            if n == 0:
                ...
                #二値化処理
                img_th = cv2.threshold(Im, threshold, 255, cv2.THRESH_BINARY)[1]
